    ...
    $(xmlNode).find('subelement').each(function() {
        ...
        switch (type) {
            ...
            case "QUESTION":
                ...
                temp += "</select></label><img src='../../../common/images/wrong-mctable.png' id='highlight_" + count_dropdown + "' style=width:0px;height:0px;float:left;margin-left:-20px;margin-top:-20px;></img>"
