...
netacad.views.CourseIndexView.prototype.buildModuleList = function(modules, filter) {
  ...
  if (empty) {
    ...
    if(filter("type")=="PT"){  p.appendChild(this.document.createTextNode(netacad.lang.get("NoPT")));
    }else if(filter("type")=="VIDEO"){  p.appendChild(this.document.createTextNode(netacad.lang.get("NoVideo")));
    }else if(filter("type")=="LAB"){  p.appendChild(this.document.createTextNode(netacad.lang.get("NoLab")));
    }else{  p.appendChild(this.document.createTextNode(netacad.lang.get("NoItems")));
    }
